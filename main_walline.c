...
int main()
{
    ...
    c1 = printf("char:%c string:%s pointer:%p decimal:%d integer:%i unsigned:%u hex:%x HEX: %X percent:%%\n", \
	'*', "Hi!", &c1, -15, -15, 10, 576, 576);
	c2 = ft_printf("char:%c string:%s pointer:%p decimal:%d integer:%i unsigned:%u hex:%x HEX: %X percent:%%\n", \
	'*', "Hi!", &c1, -15, -15, 10, 576, 576);
	printf("Returned %d %d\t", c1, c2);
	checkret(c1, c2);
	...
	c1 = printf("smaller:%02d equal:%04d bigger:%06d with '0' and %%d\n", num, num, num);
	c2 = ft_printf("smaller:%02d equal:%04d bigger:%06d with '0' and %%d\n", num, num, num);
	printf("Returned %d %d\t", c1, c2);
	checkret(c1, c2);

	printf("---Minimum field width with precision---\n");
	c1 = printf("smaller:%2.2s equal:%4.2s bigger:%6.2s with '.2'\n", str, str, str);
	c2 = ft_printf("smaller:%2.2s equal:%4.2s bigger:%6.2s with '.2'\n", str, str, str);
	printf("Returned %d %d\t", c1, c2);
	checkret(c1, c2);
